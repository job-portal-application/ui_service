...
import type { ResumeAnalysisResponse } from "@/lib/type";
    ...
    const analyzeResume = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(
                `${env.aiServiceBaseUrl}/api/v1/ai/resume`,
                {
                    pdfBase64: base64,
                }
            );
                            ...
                            <>
                                ...
                                <div className="space-y-4 py-4 flex flex-col items-center">
                                    <button
                                        ...
                                        className="w-full max-w-md mx-auto border-2 border-dashed rounded-lg p-12 text-center cursor-pointer hover:border-blue-500 transition-colors"
                                    >
                                    ...
                                    <Button
                                        ...
                                        className="w-full max-w-md h-11 gap-2"
                                    >
                                        {loading ? (
                                            <>
